...
import { ChannelStore, GuildStore, React, TextInput, Toasts, useEffect, useMemo, UserStore, useState } from "@webpack/common";

import { getTargets, removeTarget, setTargets, subscribeTargets } from "..";
...
type EventFilter = "all" | "activity" | "message" | "presence" | "typing" | "voice";
...
function SurveillanceTab() {
    ...
    const copyEvents = () => {
        void copyToClipboard(JSON.stringify(filteredEvents, null, 2)).then(
        ...
        <SettingsTab>
            <div className={cl("root")}>
                ...
                <section className={cl("panel")}>
                    <HeadingTertiary>Targets</HeadingTertiary>
                    ...
                    <div className={cl("target-list")}>
                        ...
                        )) : <span className={cl("empty")}>No targets.</span>}
                    </div>
                </section>
