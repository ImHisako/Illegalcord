...
export default definePlugin({
    name: "MullvadDNS",
    description: "Routes Discord fetch/XHR through Mullvad DNS (194.242.2.4 / 2a07:e340::4) - NO external deps",
    authors: [Devs.YourName],  // Replace with your Discord username
    settings: {
        enabled: {
